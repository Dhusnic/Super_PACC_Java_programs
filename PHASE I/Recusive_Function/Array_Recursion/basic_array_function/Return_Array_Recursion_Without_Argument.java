...
import Recusive_Function.number_example;

public class Return_Array_Recursion_Without_Argument {
    ...
    static ArrayList<Integer> find_element(int[] arr, int index, int target) {
        ...
        ArrayList<Integer> answer_from_prev_function_call = find_element(arr, index + 1, target);
        list.addAll(answer_from_prev_function_call);
        return list;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(find_element(arr, 0, target));
    }
}
